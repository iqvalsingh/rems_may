							...
							<div class="row">
								...
								<div class="col-xs-12 col-sm-4 col-md-4">
									<div class="form-group">
										...
										<input type="number" class="form-control" name="garages" id="garages"/>
									</div>
								</div>
								<!-- .col-md-4 end -->
								<div class="col-xs-12 col-sm-4 col-md-4">
								...
								<div class="col-xs-12 col-sm-4 col-md-4">
									<div class="form-group">
										...
										<input type="number" class="form-control" name="rentOrSalePrice" id="salerentprice"
											required="true"/>
									</div>
								</div>
								<!-- .col-md-4 end -->
								<div class="col-xs-12 col-sm-4 col-md-4">
									<div class="form-group">
										...
										<input type="number" class="form-control" name="beforePriceLabel"
											id="beforepricelabel" placeholder="ex: start from"/>
									</div>
								</div>
								<!-- .col-md-4 end -->
								<div class="col-xs-12 col-sm-4 col-md-4">
									<div class="form-group">
										...
										<input type="number" class="form-control" name="afterPriceLabel"
											id="afterpricelabel" placeholder="ex: monthly"/>
									</div>
								</div>
